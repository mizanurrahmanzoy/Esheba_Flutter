    ...
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
        ...
        builder: (context, snapshot) {
          ...
          final completed =
              orders.where((o) => o.data()['status'] == 'completed').length;
          final ongoing =
              orders.where((o) => o.data()['status'] == 'in_progress').length;
          final failed =
              orders.where((o) => o.data()['status'] == 'cancelled').length;
